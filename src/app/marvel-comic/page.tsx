  ...
  return (
    ...
    >
      ...
      <div className="w-[90%] flex justify-between items-center mt-[37px]">
        <h2 className="font-roboto font-medium text-4xl">Marvel Comics</h2>
      ...
      <div className="w-[90%] flex mt-[19px] justify-between mb-[50px]">
        ...
        <div className="w-[55%]">
          ...
          <p className="mt-3 font-roboto text-justify font-light">
            Este é um projeto que lista todos os personagens e quadrinhos da
            marvel, fiz o uso da Api oficial da marvel para consumir os dados e
            utilizei o Figma para construir o Layout.
          </p>
        </div>
        {/* Techs */}
        <div>
